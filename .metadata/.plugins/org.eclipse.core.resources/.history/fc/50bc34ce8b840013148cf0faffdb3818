...
public class Average {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = 0; scan.hasNext(); sum += scan.nextInt()) { // Initialise i to 0; loop while there is another token for the Scanner; add the next integer in the Scanner's feed to the sum every iteration
