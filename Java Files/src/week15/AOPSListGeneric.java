...
public interface AOPSListGeneric<E> {
    ...
    public void insert(E x, int position) throws ListIndexOutOfBoundsException; // put x into the given position
    public void replace(E x, int position) throws ListIndexOutOfBoundsException; // replace given position with x
    public E get(int position) throws ListIndexOutOfBoundsException; // return element in given position
    ...
    public void remove(int position) throws ListIndexOutOfBoundsException; // delete the element at given position
